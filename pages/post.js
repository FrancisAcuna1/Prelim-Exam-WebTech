...
import Navbar from "./Tabs Component/navbar";
                            ...
                            <CardActionArea>
                                <CardContent>
                                    ...
                                    <>  
                                        ...
                                        {/* <Button variant="outlined" href={`.Dashboard/Comments/${item.id}`}sx={{marginTop:'20px'}}>View Comment</Button> */}
                                        <Button variant="outlined" onClick={() => router.push(`/comments?postId=${item.id}`)} sx={{ marginTop: '20px' }}>View Comment</Button>
